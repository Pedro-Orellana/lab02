...
public class Therapist {
    ...
    public static String[] questions = { 
        ...
        "Tell me more about it, what is this \"replace\" you are talking about (options)",
    ...
    public static Boolean therapySession(String response) {
        ...
        //TODO: check if the user really wants to continue or if they input an invalid option
